function _tide_two_line_prompt
    set -l left_prompt (_tide_two_line_left_prompt)
    set -l right_prompt (_tide_two_line_right_prompt)
...
function _tide_two_line_left_prompt
...
function _tide_two_line_right_prompt
    set -g _tide_last_item_was_newline
